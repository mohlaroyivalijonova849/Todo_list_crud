...
function ShowTodos() {
  ...
  todos.forEach((item, i) => {
    listGroupTodo.innerHTML += `<li onclick='setCompleted(${i})' class="list-group-item d-flex justify-content-between  ${
...
// show error
function showMesseasage(where, message) {
...
formCreate.addEventListener("submit", (e) => {
  ...
  if (todoText.length) {
    ...
    showMesseasage("message-create", "Plase,Enter some todo...");
  }
});
...
formEdit.addEventListener("submit", (e) => {
  ...
  if (todoText.length) {
    ...
    showMesseasage("message-edit", "Plase,Enter some todo...");
  }
});
